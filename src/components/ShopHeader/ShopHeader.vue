<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="isShowTitle=true">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="isShowSupport=true">
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[0].type">
          <span class="content-tag">
    ...
    <div class="shop-brief-modal" v-show="isShowTitle">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isShowTitle=false">
...
<script>
  import {mapState} from 'vuex'
    export default {
      data(){
        return {
          isShowTitle : false,   //是否显示公告
          isShowSupport :false,  //是否显示优惠列表
